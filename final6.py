...
# After the loop, print hotspot information
print("Potential hotspots based on incidents:")
for location in set(incident_locations):
    count = incident_locations.count(location)
